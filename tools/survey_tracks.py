...
계열규칙 = [
    ("의약·간호", r"간호|약학|약자원|의예|의학과|수의|치의|한의|물리치료|작업치료|임상병리|방사선|"
                r"치위생|응급구조|보건"),
    ...
    ("공학", r"공학|기계|전자|전기|반도체|컴퓨터|소프트|SW|IT|정보통신|통신|신소재|재료|화공|고분자|나노|"
             r"토목|건축|건설|도시|조선|해양시스템|항공|우주|원자|에너지|자동차|로봇|메카|산업|섬유|"
             r"세라믹|금속|광|제어|계측|융합기전|시스템공|AI|인공지능|데이터|보안|게임|콘텐츠공|"
...
print("== 대학 안에서의 폭 (모집단위별 평균의 최저~최고)")
폭 = []
