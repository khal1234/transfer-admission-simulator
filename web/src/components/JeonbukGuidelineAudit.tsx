...
import { JEONBUK_GUIDELINE_AUDITS } from "../data/jeonbukGuidelineAudit";

export default function JeonbukGuidelineAudit() {
  return (
    <details className="guideline-audit">
      <summary className="guideline-audit-summary">
        <span>
          <FileCheck2 size={19} aria-hidden="true" />
          전북대 2024~2026 모집요강 원문 대조 결과
        </span>
      ...
      <div className="guideline-audit-body">
        <p className="guideline-audit-intro">
          공식 PDF의 배점표·환산식·TOEIC 환산표와 저장 데이터 및 실제 계산
          코드를 대조했습니다. 아래의 “수정 전 틀린 내용”은 이번 점검에서 발견해
          바로잡은 항목이며, PDF 뷰어의 표시 페이지를 기준으로 직접 확인할 수
          있습니다.
        </p>

        <div className="guideline-audit-years">
          {JEONBUK_GUIDELINE_AUDITS.map((audit) => {
              ...
              <details className="guideline-audit-year" key={audit.year}>
                ...
                <div className="guideline-audit-year-body">
                  ...
                  <iframe
                    ...
                    src={viewerUrl}
                    title={`전북대학교 ${audit.year}학년도 편입학전형 모집요강 PDF`}
                    loading="lazy"
                  />
