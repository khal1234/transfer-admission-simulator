...
export const TRANSFER_REVIEWS: readonly TransferReview[] = [
  ...
  {"id":8582,"title":"인천대 전자 — 토익 만점·전공복습·면접 준비 합격수기","url":"https://gall.dcinside.com/mgallery/board/view/?id=natpass&no=8582","publishedAt":"2026-08-05","departmentGroup":"전기·전자공학부","universities":["인천대학교"],"comparison":false},
